    ...
    constructor(chainId, url, batchWaitTimeMs) {
        ...
        this.clearBatch = async () => {
            ...
            for (const result of json) {
                ...
                if ('error' in result) {
                    reject(new RequestError((_a = result === void 0 ? void 0 : result.error) === null || _a === void 0 ? void 0 : _a.message, (_b = result === void 0 ? void 0 : result.error) === null || _b === void 0 ? void 0 : _b.code, (_c = result === void 0 ? void 0 : result.error) === null || _c === void 0 ? void 0 : _c.data));
                }
